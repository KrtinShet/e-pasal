  ...
  return (
    <ThemeProvider initialTokens={tokens}>
      <div className={`transition-all duration-300 ${deviceClass[device]}`}>
        <div className="overflow-hidden rounded-xl border border-[var(--grey-200)] bg-[var(--color-background)] shadow-sm">
          <div className="flex items-center justify-between bg-[var(--primary-main)] px-4 py-3 text-white">
            <div>
          ...
          <div className="space-y-4 p-4">
            <div className="rounded-lg border border-[var(--grey-200)] bg-[var(--grey-100)] p-4">
              <p className="text-xs uppercase tracking-wide text-[var(--grey-400)]">
                Hero headline
              </p>
              <h4 className="mt-1 font-display text-2xl font-bold text-[var(--grey-900)]">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <button className="rounded-md bg-[var(--primary-main)] px-4 py-2 text-sm font-semibold text-white">
                  Primary CTA
                </button>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="rounded-lg border border-[var(--grey-200)] bg-[var(--color-background)] p-3">
                <p className="text-xs text-[var(--grey-400)]">Featured Product</p>
                <p className="mt-1 font-semibold text-[var(--grey-900)]">Himalayan Tea Bundle</p>
                <p className="mt-2 text-sm text-[var(--primary-main)]">Rs. 1,500</p>
              </div>
              <div className="rounded-lg border border-[var(--grey-200)] bg-[var(--color-background)] p-3">
                <p className="text-xs text-[var(--grey-400)]">Status palette</p>
            ...
            <div className="rounded-lg border border-[var(--grey-200)] bg-[var(--grey-100)] p-3">
              <p className="text-xs text-[var(--grey-400)]">Typography sample</p>
              <h5 className="mt-1 font-display text-xl text-[var(--grey-900)]">Section Heading</h5>
