...
function EmptyCart() {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      <CartIcon />
      <h2 className="mt-6 text-heading-2 font-display font-semibold text-[var(--charcoal)]">
        Your cart is empty
      </h2>
      <p className="mt-3 text-body-lg text-[var(--graphite)] max-w-md">
...
function CartPageSkeleton() {
  return (
    <div className="container-main py-8 md:py-12">
      <div className="h-8 w-48 bg-[var(--cream-dark)] rounded animate-pulse" />
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex gap-4 p-4 bg-[var(--cream-dark)] rounded-lg animate-pulse">
              <div className="w-20 h-20 bg-[var(--mist)]/30 rounded-lg" />
              <div className="flex-1 space-y-3">
                <div className="h-4 w-3/4 bg-[var(--mist)]/30 rounded" />
                <div className="h-4 w-1/2 bg-[var(--mist)]/30 rounded" />
              </div>
            </div>
          ))}
        </div>
        <div className="h-64 bg-[var(--cream-dark)] rounded-lg animate-pulse" />
      </div>
    </div>
  );
}
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-heading-1 font-display font-semibold text-[var(--charcoal)]">
          ...
          {summary.totalItems > 0 && (
            <span className="ml-3 text-heading-3 text-[var(--slate)] font-normal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          <div className="lg:col-span-2">
            <div className="card p-0">
              <div className="divide-y divide-[var(--mist)]/20">
                {items.map((item) => (
            ...
            <div className="mt-6 flex items-center justify-between text-body">
              <span className="text-[var(--graphite)]">Subtotal:</span>
          ...
          <div className="lg:col-span-1">
            <div className="card sticky top-24">
              <h2 className="text-heading-3 font-semibold text-[var(--charcoal)] mb-6">
                Order Summary
              </h2>
